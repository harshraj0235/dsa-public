    ...
    <div className="bg-gray-100 font-roboto">
      <div className="container mx-auto p-4">
            ...
            <table className="min-w-full bg-white">
              ...
              <tbody>
                ...
                <tr className="border-b">
                  ...
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Armstrong Numbers</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Print all Divisors</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Check for Prime</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
              </tbody>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6 border-l-4 border-green-500">
          <h3 class="text-xl font-semibold mb-2 text-yellow-600">Lec 5: Learn Basic Recursion</h3>
          <p class="text-gray-600 mb-4">0 / 9</p>
            ...
            <table class="min-w-full bg-white">
              <thead>
                <tr class="bg-green-100">
                  ...
                  <th class="py-2 px-4 text-left">Solution</th>
                </tr>
              </thead>
              <tbody>
                <tr class="border-b">
                  <td class="py-2 px-4">Understand recursion by print something N times</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Print name N times using recursion</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Print 1 to N using recursion</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Print N to 1 using recursion</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Sum of first N numbers</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Factorial of N numbers</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Reverse an array</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Check if a string is palindrome or not</td>
                  <td class="py-2 px-4">Medium</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Fibonacci Number</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
              </tbody>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6 border-l-4 border-green-500">
          <h3 class="text-xl font-semibold mb-2 text-yellow-600">Lec 6: Learn Basic Hashing</h3>
          <p class="text-gray-600 mb-4">0 / 3</p>
          <div class="overflow-x-auto">
            <table class="min-w-full bg-white">
              <thead>
                <tr class="bg-green-100">
              ...
              <tbody>
                <tr class="border-b">
                  <td class="py-2 px-4">Hashing Theory</td>
                  <td class="py-2 px-4">Medium</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Counting frequencies of array elements</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white px-4 py-2 rounded">Solution</a></td>
                </tr>
                <tr class="border-b">
                  <td class="py-2 px-4">Find the highest/lowest frequency element</td>
                  <td class="py-2 px-4">Easy</td>
                  <td class="py-2 px-4"><a href="#" class="bg-green-500 text-white
